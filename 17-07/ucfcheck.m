...
for v = 1:length(voltage_noise_levels)
    for c = 1:length(current_noise_levels)
        ...
        % Repeat the same process for Pink Noise
...
% --- End of Code ---
function Voc = ocv(SOC)
    Voc = 3.435 * SOC + 0.235;  % A simple OCV-SOC relationship
end